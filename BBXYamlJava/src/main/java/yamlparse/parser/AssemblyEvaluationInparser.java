 ...
 * @author Mark
 */
public class AssemblyEvaluationInparser extends Inparser{
    private URL url;
    ...
    private AssemblyEvaluationTopType parseResults; 
     ...
     * use updateFile() 
     */
    public AssemblyEvaluationInparser(String path, String url){
        this.localPath = path;
    ...
    public void parse(){ 
        try {
            ...
            this.parseResults = mapper.readValue(yamlString, yamlparse.datatypes.assemblyevaluation.AssemblyEvaluationTopType.class);
        } catch (IOException ex) {
            Logger.getLogger(AssemblyEvaluationInparser.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    @Override
    public AssemblyEvaluationTopType getParseResults() {
        return parseResults;
    }
