 ...
 */
public class AssemblyEvaluationInparser {
    ...
    private AssemblyEvaluationTopType evaluations; 
   
    
    public AssemblyEvaluationInparser(){
        this.localPath = Constants.ASSEMBLY_EVALUATION_LOCAL_FILE_NAME;
        this.evaluations = null;
        this.yamlString = null;
        this.webURLString = Constants.ASSEMBLY_EVALUATION_FILE_URL;
    }
    ...
    public void parse(){ 
        try {
            ...
            this.evaluations = mapper.readValue(yamlString, yamlparse.datatypes.assemblyevaluation.AssemblyEvaluationTopType.class);
    ...
    public String getEvaluationString(){
        ...
        String ret = new String(
                "$schema: " + this.evaluations.get$schema() +n+
                "title: " +this.evaluations.getTitle()
        );
        return ret;
    }
    ...
    public AssemblyEvaluationTopType getAssemblyEvaluations() {
        return evaluations;
    }
